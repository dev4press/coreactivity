        ...
        <div class="d4p-layout-grid">
            <div class="d4p-layout-unit whole align-center">
                ...
                <p class="lead-description">
                    CoreSocial Pro is a new plugin supporting many social networks.
                </p>
                <p>
                    Version 1.0 is the culmination of the years of (very slow) development process for the plugin first started way back in 2017 and used only
                    internally.
                </p>
            </div>
        </div>
    ...
    <div class="d4p-whatsnew-section core-grid">
        <div class="core-row">
            <div class="core-col-sm-12 core-col-md-6">
                ...
                <p>
                    Share block can be added automatically, or you can use block (as well as block in the sidebar), shortcode or function. You can have share for posts and terms archives, or any custom URL on the website, and you can also include Like button along the share buttons.
                </p>
                <p>
                    Share block can be added as a Floating element site wide, positioned on left or right side of the screen.
                </p>
            </div>
            <div class="core-col-sm-12 core-col-md-6">
                <img alt="CoreSocial Share" src="https://storage.dev4press.com/plugins/coresocial/1.0/about/share.jpg"/>
            </div>
        </div>
        ...
        <div class="core-row">
            <div class="core-col-sm-12 core-col-md-6">
                ...
                <p>
                    You can add both blocks more than once, with different settings and different included networks and buttons.
                </p>
            </div>
            <div class="core-col-sm-12 core-col-md-6">
                <img alt="CoreSocial Blocks" src="https://storage.dev4press.com/plugins/coresocial/1.0/about/blocks.jpg"/>
            </div>
        </div>
    </div>
