	...
	<div class="d4p-setup-wrapper">
		<div class="d4p-update-info">
			...
			<div class="d4p-install-block">
				...
				<div>
					<?php _e( "Update completed.", "coreactivity" ); ?>
				</div>
			</div>

			<div class="d4p-install-confirm">
				<a class="button-primary" href="<?php echo panel()->a()->panel_url( 'about' ) ?>&update"><?php _e( "Click here to continue", "coreactivity" ); ?></a>
			</div>
		</div>
		<?php echo coreactivity()->recommend(); ?>
	</div>
</div>
